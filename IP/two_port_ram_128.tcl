...
################################################################
# This is a generated script based on design: two_port_ram_128
#
...
# source two_port_ram_128_script.tcl
...
set design_name two_port_ram_128
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set addra_0 [ create_bd_port -dir I -from 4 -to 0 addra_0 ]
  set addrb_0 [ create_bd_port -dir I -from 4 -to 0 addrb_0 ]
  set clka_0 [ create_bd_port -dir I -type clk clka_0 ]
  set clkb_0 [ create_bd_port -dir I -type clk clkb_0 ]
  set dina_0 [ create_bd_port -dir I -from 127 -to 0 dina_0 ]
  set dinb_0 [ create_bd_port -dir I -from 127 -to 0 dinb_0 ]
  set douta_0 [ create_bd_port -dir O -from 127 -to 0 douta_0 ]
