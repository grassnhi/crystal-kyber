...
generate
    for (genvar z5 = 1; z5 < 64; z5 = z5 + 1) begin: step2_x0
        assign D[0][z5] = C[4][z5] ^ C[1][(z5-1)%64];
    end
endgenerate
...
generate
    for (genvar z6 = 1; z6 < 64; z6 = z6 + 1) begin: step2_x1
        assign D[1][z6] = C[0][z6] ^ C[2][(z6-1)%64];
    end
endgenerate
...
generate
    for (genvar z7 = 1; z7 < 64; z7 = z7 + 1) begin: step2_x2
        assign D[2][z7] = C[1][z7] ^ C[3][(z7-1)%64];
    end
endgenerate
...
generate
    for (genvar z8 = 1; z8 < 64; z8 = z8 + 1) begin: step2_x3
        assign D[3][z8] = C[2][z8] ^ C[4][(z8-1)%64];
    end
endgenerate
...
generate
    for (genvar z9 = 1; z9 < 64; z9 = z9 + 1) begin: step2_x4
        assign D[4][z9] = C[3][z9] ^ C[0][(z9-1)%64];
    end
endgenerate
