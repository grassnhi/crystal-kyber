...
generate
    for (genvar i = 1; i < 64; i = i + 1) begin: t0
        assign A_out[1][0][i] = A[1][0][(i - 1) % 64];
    end
endgenerate
...
generate
    for (genvar i1 = 3; i1 < 64; i1 = i1 + 1) begin: t1
        assign A_out[0][2][i1] = A[0][2][(i1 - 3) % 64];
    end
endgenerate
...
generate
    for (genvar i2 = 6; i2 < 64; i2 = i2 + 1) begin: t2
        assign A_out[2][1][i2] = A[2][1][(i2 - 6) % 64];
    end
endgenerate
...
generate
    for (genvar i3 = 10; i3 < 64; i3 = i3 + 1) begin: t3_2
        assign A_out[1][2][i3] = A[1][2][(i3 - 10) % 64];
    end
endgenerate
...
generate
    for (genvar i4 = 15; i4 < 64; i4 = i4 + 1) begin: t4_2
        assign A_out[2][3][i4] = A[2][3][(i4 - 15) % 64];
    end
endgenerate
...
generate
    for (genvar i5 = 21; i5 < 64; i5 = i5 + 1) begin: t5_2
        assign A_out[3][3][i5] = A[3][3][(i5 - 21) % 64];
    end
endgenerate
...
generate
    for (genvar i6 = 28; i6 < 64; i6 = i6 + 1) begin: t6_2
        assign A_out[3][0][i6] = A[3][0][(i6 - 28) % 64];
    end
endgenerate
...
generate
    for (genvar i7 = 36; i7 < 64; i7 = i7 + 1) begin: t7_2
        assign A_out[0][1][i7] = A[0][1][(i7 - 36) % 64];
    end
endgenerate
...
generate
    for (genvar i8 = 45; i8 < 64; i8 = i8 + 1) begin: t8_2
        assign A_out[1][3][i8] = A[1][3][(i8 - 45) % 64];
    end
endgenerate
...
generate
    for (genvar i9 = 55; i9 < 64; i9 = i9 + 1) begin: t9_2
        assign A_out[3][1][i9] = A[3][1][(i9 - 55) % 64];
    end
endgenerate
